    ...
    <>
      ...
      <div className="p-2">
        ...
        <label className="text-neutral mb-2 block text-sm font-medium">
          ...
          {pluralForm(Math.floor(props.duration / 60), [
            "минута",
            "минуты",
            "минут",
          ])}{" "}
        ...
        <div>
          <label className="label cursor-pointer">
            <span className="label-text">
              Отображать ТОЛЬКО количество проголосовавших/непроголосовавших
              людей
            </span>
            <input
              type="checkbox"
              ...
              onChange={(event) =>
                props.setShowOnlyVotersCount(event.target.checked)
              }
